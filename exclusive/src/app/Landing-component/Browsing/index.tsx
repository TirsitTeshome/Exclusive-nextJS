      ...
      {/* <div className="mb-10"><hr/></div> */}
        <div className="flex gap-8 overflow-x-auto no-scrollbar ">
          {categories.map((cat, index) => (
            <div key={cat.name} className={`rounded-sm flex flex-col items-center justify-center w-520 h-38 border-gray-500 border  cursor-pointer transition-colors duration-200 bg-white text-black hover:bg-red-500 hover:text-white font-poppins hover:border-0 py-5`} 
            >
              {cat.icon}
