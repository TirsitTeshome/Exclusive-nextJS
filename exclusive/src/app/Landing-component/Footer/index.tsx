...
const Footer = () => {
  return (
    <footer className={`${poppins.className} bg-black text-white py-16 w-screen mx-auto`}>
      <div className="ml-[120px] w-[70vw] grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <form className="mt-5">
            <div className="flex border border-white rounded px-3 py-2 items-center w-60">
              <input
                ...
                className="bg-black text-white relative w-50"
              />
              <button
                type="submit"
                aria-label="Submit email"
                className="ml-auto relative right-0"
              >
                <svg
        ...
        <div className="space-y-4 border-gray-700 pr-4 text-base">
        ...
        <div className="space-y-4 text-base">
          ...
          <div className="flex space-x-3 mb-3">
            <div className="relative w-22 h-22 border border-white">
              <Image
                src="/pics/qr.png"
                alt="QR code"
                fill
      ...
      <div className="space-x-3 text-center text-gray-500 pt-8 text-sm border-t border-gray-700 mt-5 mb-auto relative top-7">
